## Mini Internship Management System
A C# console-based project demonstrating core **Object-Oriented Programming (OOP)** concepts through an Internship Management System.
...
1. **Clone the repository**
    ```bash
    git clone https://github.com/Hasan-Uddin/Mini-Internship-Management-System-C-OOP.git
    ```
